...
/** Test fury table factory. Only used in flink fury test module. */
public class TestFuryTableFactory
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new TestFuryTableSource(decodingFormat, producedDataType);
    }
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        return new TestFuryTableSink(decodingFormat, dataType);
    }

    @Override
    public String factoryIdentifier() {
        return "fury-test-connector";
    }
